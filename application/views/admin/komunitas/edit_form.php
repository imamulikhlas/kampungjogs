...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
		...
		<div class="container-fluid">
                <h1 class="mt-4">Edit Data Komunitas</h1>
                   <ol class="bre adcrumb mb-4">
                       <li class="breadcrumb-item active">Edit Data Komunitas - Admin</li>
                   </ol>
                <main>
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/komunitass/') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
					</div>
					<div class="card-body">

						<form action="" method="post" enctype="multipart/form-data" >
							<input type="hidden" name="id" value="<?php echo $komunitas->ID?>" />
							...
							<div class="form-group">
								...
								<input type = "hidden" name = "old_gambar" value = "<?php echo $komunitas->gambar ?>" />
								<div class="invalid-feedback">
