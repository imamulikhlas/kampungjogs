...
class Komunitass extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("owner/komunitas/list", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("owner/komunitas/new_form");
    }

    public function edit($id = null)
    {
        if (!isset($id)) redirect('owner/komunitass');
        ...
        $this->load->view("owner/komunitas/edit_form", $data);
    }
